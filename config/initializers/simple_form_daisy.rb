...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-control', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.wrapper :label, tag: 'label', class: 'label' do |lb|
      ...
      lb.use :full_error, wrap_with: { tag: 'span', class: 'label-text-alt text-error' }
    end
