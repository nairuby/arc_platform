...
gem 'motor-admin', '~> 0.4.7' # Motor Admin allows you to deploy a no-code admin panel for your application in less than a minute
...
gem 'sendgrid-actionmailer', '~> 3.2' # An ActionMailer adapter to send email using SendGrid's HTTPS Web API (instead of SMTP).
